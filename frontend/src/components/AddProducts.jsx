...
const AddProducts = () => {
    ...
    return (
        <div className='flex-wrap p-5 pt-12 md:pt-28 lg:pt-32 space-y-5 mb-12'>
            <div className=''>
            ...
            <form action="">
                <div className=''>
                    ...
                    <div className='flex-col gap-3 items-center'>
                        <div className='block items-center gap-2'>
                            <h1>Description</h1>
                            <textarea type="text" name="" id="" className='w-full border rounded-md shadow-lg py-1 pl-2'/>
                        </div>
                        <span className=' text-xs'>set a description to the product for better visibility</span>
                    </div>

                    <div className='block gap-3 items-center md:flex'>
                        <h1>Images</h1>
                ...
                {discountType === "TimeSale" && (
                    <div className=" mt-4 space-y-3">
                        {/* Time Input */}
                        <div>
                            <label className="block gap-3 text-gray-700 font-semibold">Set Time:</label>
                        ...
                        <div>
                            <label className="block gap-3 text-gray-700 font-semibold">
                ...
                <div className='mt-5'>
                    <button className='w-full bg-blue-400 text-white rounded-md shadow-lg py-1 pl-2'>
                        Save
                    </button>
                </div>
            </form>
